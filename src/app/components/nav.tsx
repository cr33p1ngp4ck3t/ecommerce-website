				...
				<div className="s-display ">
					...
					<div id="items">
						<Image
							width={23.33}
							height={18.67}
							src={"https://i.postimg.cc/rFddHn12/user.png"}
							alt=""
						/>
						<Image
							width={22.17}
							height={22.17}
							src={"https://i.postimg.cc/DfpJBkbc/search.png"}
							alt=""
						/>
						<Image
							width={23.33}
							height={20.81}
							src={"https://i.postimg.cc/NFnKMmwn/heart.png"}
							alt=""
						/>
						<Image
							width={24.53}
							height={22.06}
							src={"https://i.postimg.cc/JnPyfSYM/shopcart.png"}
							alt=""
						/>
					</div>
				</div>
